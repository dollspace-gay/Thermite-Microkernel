...
| G-008 | closed upstream and locally | pinned Forge commit `4fa63cb1` deterministically emits the rich multi-field-enum composition bundle; three independent receipts, sources, and rlibs match and replay succeeds | preserve the exact tool/source pins and replay regression |
