...
same-source content-preserving byte decoder depends on the no-`vstd` kernel slice
model tracked by Thermite
[#108](https://github.com/dollspace-gay/Thermite/issues/108). The loader, page
